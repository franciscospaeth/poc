...
public class DataGrid extends AbstractComponent<IDataGrid> implements IDataGrid {
	...
	public void setColumnModel(final ColumnModel columnModel) {
		getDelegated().setColumnModel(columnModel);
	}

	@Override
	public ColumnModel getColumnModel() {
		return getDelegated().getColumnModel();
	}
